...
/**
 * Sends `ensureIndex` messageAPI to mongo for each index declared in the schema.
 *
 * ####Example:
 *
 ...
 *
 * The `ensureIndex` messageAPI are not sent in parallel. This is to avoid the `MongoError: cannot add index with a background operation in progress` error. See [this ticket](https://github.com/LearnBoost/mongoose/issues/1365) for more information.
 *
 ...
 *
 * @param {Array} array an array of pipeline messageAPI
 * @param {Object} [options]
 * @param {Function} callback
