...
ApnsService.prototype.send = function (tags, payload, callback) {
  var headers = {};
   ...
   console.log("Successfully reached here with tags", tags);
   console.log("Successfully reached here with payload", payload);
  ...
  console.log("Successfully reached here with headers", headers);
